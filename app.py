...
CHAPTERS = [
    ...
    ('第十节 财务报告', ['审计报告', '财务报表', '合并财务报表项目注释', '母公司财务报表主要项目注释',
        ...
        '预付款项', '债权投资', '借款', '预收款项',
        # 新版 Excel（Word 最终版）注释表名去掉前缀后的科目/条目关键词
        '内控', '税种', '货币资金', '交易性金融资产', '衍生金融资产', '买入返售', '其他流动资产',
        '其他非流动资产', '其他非流动金融资产', '交易性金融负债', '衍生金融负债', '卖出回购',
        '合同负债', '吸收存款', '发放贷款', '拆出资金', '持有待售', '其他流动负债', '预计负债',
        '递延收益', '其他非流动负债', '股本', '资本公积', '库存股', '其他综合收益', '专项储备',
        '盈余公积', '一般风险准备', '未分配利润', '所有权或使用权受到限制', '营业收入和营业成本',
        '税金及附加', '其他收益', '投资收益', '信用减值损失', '资产减值损失', '资产处置收益',
        '营业外收入', '营业外支出', '利息净收入', '手续费及佣金', '公允价值变动收益', '财务费用',
        '管理费用', '销售费用', '研发费用', '研发项目', '租赁负债', '长期应付款', '应付票据',
        '应付手续费及佣金', '向中央银行借款', '贷款', '市场风险', '敏感性分析', '风险管理',
        '共同经营', '合营', '母公司情况', '其他关联方情况', '处置子公司', '重要性标准',
        '所有者权益变动表', '开发支出', '分布情况']),
]
